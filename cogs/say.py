...
class say(commands.Cog):
   ...
   async def say(self, ctx, content: Option(str, "› what should i say? 📝"), channel: Option(discord.TextChannel, "› what channel should i say this in? 💬", required=False), reply_to: Option(str, "› the id of the message to reply to in the channel 💬", name="reply-to-message-id", required=False)):
      if len(content) > 2000:
